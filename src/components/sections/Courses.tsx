...
const academicCourses = [
  {
    ...
    title: "Class 3–8",
    bangla: "অল সাবজেক্ট",
    desc: "Complete academic support for all subjects — Bangla, English, Math, Science and more.",
    color: "bg-blue-600",
    badge: "School"
  },
  {
    ...
    title: "Class 9–HSC",
    bangla: "সাবজেক্ট ভিত্তিক",
    desc: "Subject-specific coaching: গণিত, ইংরেজি, পদার্থবিজ্ঞান, রসায়ন, হিসাব বিজ্ঞান, জীববিজ্ঞান, ICT, বাংলা, অন্যান্য।",
    color: "bg-indigo-600",
    badge: "School"
  },
  {
    icon: <Languages className="w-6 h-6 text-white" />,
    title: "Spoken English — Group A",
    bangla: "Class Play–Five (Sat, Mon & Wed)",
    desc: "Daily conversation, grammar, pronunciation, listening & speaking, public speaking, and interview skills.",
    color: "bg-rose-500",
    badge: "English"
  },
  {
    icon: <Languages className="w-6 h-6 text-white" />,
    title: "Spoken English — Group B",
    bangla: "Class Six–Above (Sun, Tue & Thu)",
    desc: "Advanced spoken English for Class 6 and above — pronunciation, grammar in use, and confidence building.",
    color: "bg-pink-500",
    badge: "English"
  },
];
...
const computerCourses = [
  {
    ...
    title: "Computer Basic & Office",
    bangla: "কম্পিউটার বেসিক এন্ড অফিস এপ্লিকেশন",
    desc: "Essential computer skills, MS Word, Excel, PowerPoint, and office productivity tools.",
    color: "bg-cyan-600",
    badge: "IT"
  },
  {
    icon: <Code className="w-6 h-6 text-white" />,
    title: "Freelancing & Programming",
    bangla: "ফ্রিল্যান্সিং ও প্রোগ্রামিং",
    desc: "Python, Java, C#, Node.js, TypeScript — build real-world projects and kickstart a freelancing career.",
    color: "bg-violet-600",
    badge: "IT"
  },
  {
    ...
    title: "ICT",
    bangla: "তথ্য ও যোগাযোগ প্রযুক্তি",
    desc: "Full ICT curriculum covering computer fundamentals, networking, and digital communications.",
    color: "bg-teal-600",
    badge: "IT"
  },
  {
    ...
    bangla: "ইংরেজি ভাষা",
    desc: "Reading, writing, comprehension, and grammar — build solid English foundations for school and career.",
    color: "bg-amber-500",
    badge: "Language"
  },
];
...
function CourseCard({ course }: { course: typeof academicCourses[0] }) {
  return (
    <Card className="h-full border-border/50 hover:border-primary/30 transition-all hover:shadow-lg bg-card group">
      <CardHeader>
        <div className="flex items-start justify-between mb-3">
          <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${course.color} shadow-inner group-hover:scale-110 transition-transform`}>
            {course.icon}
          </div>
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h3 className="text-3xl md:text-5xl font-bold text-foreground mb-4">
            Courses Designed for Your Need
          </h3>
          <p className="text-lg font-bangla text-muted-foreground">
        ...
        <div className="mb-12">
          ...
          {/* Class 9-HSC Subjects Quick View */}
          <motion.div
        ...
        >
          ...
          <a
            href="#contact"
            className="inline-block bg-secondary text-secondary-foreground font-bold px-8 py-3 rounded-xl hover:bg-secondary/90 transition-colors"
          >
